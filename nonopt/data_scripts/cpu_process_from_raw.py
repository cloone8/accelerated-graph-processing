...
def draw_performance_graphs_cpu(graphdata, title, algorithm, name_filter=""):
    ...
    rects1 = ax.bar(ind - width/2, openmp_data, width, yerr=openmp_std, label='OpenMP', color="#bd0000")
...
def draw_all_graphs_cpu(data):
    # Create Pagerank performance graphs
    draw_performance_graphs_cpu(data, "Normalised pagerank runtimes of graph500 graphs", "PAGERANK", "graph500")
    draw_performance_graphs_cpu(data, "Normalised pagerank runtimes of KONECT graphs", "PAGERANK", "KONECT")
    draw_performance_graphs_cpu(data, "Normalised pagerank runtimes of SNAP graphs", "PAGERANK", "SNAP")
